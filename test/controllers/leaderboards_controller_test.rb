...
class LeaderboardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leaderboard" do
    assert_difference('Leaderboard.count') do
      post leaderboards_url, params: { leaderboard: { player_id: @leaderboard.player_id, ranking: @leaderboard.ranking } }
    end
  ...
  test "should update leaderboard" do
    patch leaderboard_url(@leaderboard), params: { leaderboard: { player_id: @leaderboard.player_id, ranking: @leaderboard.ranking } }
